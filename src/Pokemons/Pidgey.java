...
public class Pidgey
{
    protected String nome = "Pidgey";
    protected float peso = 1.8f;
    protected String som = "PidgeySound";
    ...
    protected int defesaEspecial = 67;
    protected int velocidade = 105;
    ...
    Voador v = new Voador(ataqueBasico, ataqueEspecial);

    public int atacar()
    {
        dano = v.escolheAtaqueVoador();
        return dano;
    ...
    public String qualAtaque()
    {
        ...
        switch (x)
        {
            ...
            case 1:
                return "<br>Ataque do tipo Voador!  ==> " + "Ataque Aéreo!";
            case 2:
                return "<br>Ataque do tipo Voador!  ==> " + "Lâmina de Ar!";
            case 3:
                return "<br>Ataque do tipo Voador!  ==> " + "Bico Broca!";
            case 4:
                return "<br>Ataque do tipo Voador!  ==> " + "Furacão! - ULTIMATE";
        }
        return "erro!";
    }
